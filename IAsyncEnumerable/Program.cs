...
";
        ...
        static async Task Main(string[] args)
        {
            ...
            "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");
            ...
            try
            {
                await foreach(var issue in RunPagedQueryAsync(client, PagedIssueQuery,"docs",cancellationSource.Token,progressReporter))
                {
                    await Console.Out.WriteLineAsync(issue.ToString());
                }
            }
